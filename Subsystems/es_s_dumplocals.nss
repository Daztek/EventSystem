/*
    ...
    Description: A NWScript replacement for dm_dumplocals
*/
...
void DumpLocals_EventHandler(string sSubsystemScript, string sEvent)
{
    ...
    object oTarget = ES_Core_GetEventData_NWNX_Object("TARGET");
    int nType = ES_Core_GetEventData_NWNX_Int("TYPE");
    string sMessage;

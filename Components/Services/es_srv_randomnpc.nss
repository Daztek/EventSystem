/*
    ScriptName: es_srv_randomnpc.nss
    Created by: Daz

    Required NWNX Plugins:
        @NWNX[Creature Object]

    Description: An EventSystem Service that allows the creation of random NPCs
*/
...
const string RANDOM_NPC_LOG_TAG                 = "RandomNPC";
const string RANDOM_NPC_SCRIPT_NAME             = "es_srv_randomnpc";
...
void RandomNPC_PregenerateRandomNPCs(int nAmount)
{
    ...
    ES_Util_Log(RANDOM_NPC_LOG_TAG, "* Done! New cached NPC amount: " + IntToString(nIndex) + "/" + IntToString(RANDOM_NPC_PREGENERATE_MAX));
}
